...
def run_tests(fp):
    f = load(fp).count_vowels
    cases = [("Hello World",3,"mixed case"),("AEIOU",5,"all upper"),("aeiou",5,"all lower"),("rhythm",0,"no vowels"),("Apple",2,"capital A"),("",0,"empty"),("bcdfg",0,"consonants only")]
