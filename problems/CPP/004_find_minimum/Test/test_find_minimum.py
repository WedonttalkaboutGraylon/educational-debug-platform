...
def run_tests(solution_path):
    results = []
    tests = [("find_minimum({3,7,2,9,1})", "{3,7,2,9,1}", 1),("find_minimum({1})", "{1}", 1),("find_minimum({-1,-5,-2})", "{-1,-5,-2}", -5),("find_minimum({5,5,5})", "{5,5,5}", 5),("find_minimum({100,0,50})", "{100,0,50}", 0)]
    passed = failed = 0
