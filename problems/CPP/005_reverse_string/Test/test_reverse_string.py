...
def run_tests(solution_path):
    results = []
    tests = [("reverse_string('hello')", '"hello"', "olleh"),("reverse_string('a')", '"a"', "a"),("reverse_string('')", '""', ""),("reverse_string('world')", '"world"', "dlrow"),("reverse_string('12345')", '"12345"', "54321")]
    passed = failed = 0
