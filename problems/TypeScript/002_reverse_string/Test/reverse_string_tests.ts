...
async function runTests(fp: string) {
    const m = await load(fp); const f = m.reverseString;
    const cases: [string,string,string][] = [["hello","olleh","basic"],["abcd","dcba","four"],["a","a","single"],["","","empty"],["racecar","racecar","palindrome"],["Hello","olleH","mixed case"]];
